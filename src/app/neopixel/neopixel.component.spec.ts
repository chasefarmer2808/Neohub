...
import { NeopixelComponent } from './neopixel.component';
...
describe('NeopixelComponent', () => {
  let component: NeopixelComponent;
  let fixture: ComponentFixture<NeopixelComponent>;
  let de: DebugElement;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NeopixelComponent);
